...
namespace AdressBook
{
    internal static class Program
    {
        ...
        internal static List<int> conIndex = new List<int>(); //makes a list to store the correct index for buisness contacts. That way, when an item is selected, it will know the location
